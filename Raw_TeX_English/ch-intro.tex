...
Note that because this primer is freely available on GitHub and is continuously updated, the URL should link to the most recent version, while the "Commit SHA" should be that of the most recent commit when the citation is made.     