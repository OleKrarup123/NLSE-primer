...
小节~\ref{sec:sidebands}中的推导假定色散可以忽略不计，这是小$\omega_d$值和载波频率接近小节~\ref{subsec:ZDF}中解释的零色散频率的情况。在 \href{https://youtu.be/0SXPvO89jto}{本视频教程}中解释了色散对全波调制的影响。事实证明，当 $\betag_2$ 为正值时，FWM 很弱，而当 $\betag_2$ 为负值时，FWM 最为显著。
\begin{align}
